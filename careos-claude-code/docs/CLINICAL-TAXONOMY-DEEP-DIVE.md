...
- Implementation: After the 3rd completed Time Bank task, auto-trigger: "You're making a real impact. Know someone who'd be great at this? Invite a neighbor → you both get 5 bonus hours." The referral mechanic is a graph edge: `RELATE user:lisa → referred → user:karen`. The cascade visualization shows the chain: "Your help enabled Janet to help the Torres family, who helped the Johnson family."
