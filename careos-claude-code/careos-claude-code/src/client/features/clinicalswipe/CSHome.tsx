...
const SPECIALTIES = [
  { name: 'Musculoskeletal', icon: '🦴', status: 'live', physicians: 12, reviews: '2.4K' },
  { name: 'Cardiology', icon: '❤️', status: 'coming', physicians: 0, reviews: '—' },
  { name: 'Behavioral Health', icon: '🧠', status: 'coming', physicians: 0, reviews: '—' },
  { name: 'Radiology', icon: '📡', status: 'planned', physicians: 0, reviews: '—' },
  { name: 'Dermatology', icon: '🔬', status: 'planned', physicians: 0, reviews: '—' },
  { name: 'Primary Care', icon: '🩺', status: 'planned', physicians: 0, reviews: '—' },
  { name: 'Endocrinology', icon: '⚗️', status: 'planned', physicians: 0, reviews: '—' },
  { name: 'Oncology', icon: '🎗️', status: 'planned', physicians: 0, reviews: '—' },
];
...
export default function ClinicalSwipeHome() {
  ...
  const statusColor: Record<string, string> = { live: C.green, coming: C.orange, planned: C.dim };
  const statusLabel: Record<string, string> = { live: 'Live', coming: 'Q3 2026', planned: '2027+' };
  ...
  return (
    ...
    >
      <link
        href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600;700;800;900&family=JetBrains+Mono:wght@400;600&display=swap"
        rel="stylesheet"
      />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
          {SPECIALTIES.map((spec, i) => (
            ...
            >
              ...
              >
                <div style={{ fontSize: '28px' }}>{spec.icon}</div>
                <span
                  style={{
                    padding: '3px 8px',
                    borderRadius: '6px',
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 32px' }}>
        ...
        >
          {[
            ...
            { label: 'FHIR R4 Native', icon: '🔥' },
            { label: 'SOC 2 (Planned)', icon: '🛡️' },
            { label: 'HMAC-SHA256', icon: '🔐' },
      ...
      >
        <div style={{ fontSize: '13px', color: C.dim }}>
          ClinicalSwipe · Solving Health Inc. · Boulder, CO
        </div>
