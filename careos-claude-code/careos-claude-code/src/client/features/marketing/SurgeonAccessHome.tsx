...
import { surgeonAccess as C, company, fontLinks } from './design-tokens';
...
const ORTHO_WORKFLOW: WorkflowStep[] = [
  {
    step: '01',
...
const TESTIMONIAL_SCENARIOS: Testimonial[] = [
  {
...
export function SurgeonAccessHome() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: '11px', fontWeight: '800', letterSpacing: '0.5px' }}>MSK</span>{' '}
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: '14px', color: C.muted, lineHeight: '1.7', marginTop: '12px' }}>
              Built by a team that spent 7 years growing BrainLAB's orthopedic computer-assisted
            ...
            {[
              ...
              >
                <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                  <circle cx="4" cy="4" r="4" fill={C.teal} />
                </svg>
                {s}
              </div>
            ))}
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            ...
            <div style={{ fontSize: '12px', color: C.dim, lineHeight: '1.8' }}>
              ...
              {company.address}
              <br />
              surgeons@surgeonaccess.com -- {company.phone}
            </div>
          </div>
