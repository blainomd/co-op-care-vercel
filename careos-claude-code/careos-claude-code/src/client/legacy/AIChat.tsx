...
- Keep answers under 3 short paragraphs. Use bullet points for readability.`,
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: 'model', text: response.text || "I'm sorry, I couldn't process that." },
      ]);
    } catch (error) {
      ...
      setMessages((prev) => [
        ...
        {
          role: 'model',
          text: "I'm having trouble connecting right now. Please try again later or email us directly at blaine@co-op.care!",
        },
      ]);
    } finally {
      setIsLoading(false);
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: fs, fontWeight: 700, fontSize: 15 }}>
                  AI Care Navigator
                </div>
          ...
          >
            ...
            <button
              ...
              style={{
                background: input.trim() && !isLoading ? C.sage : C.border,
                color: C.w,
                border: 'none',
                width: 44,
                height: 44,
