    ...
    <footer style={{ background: C.dk2, padding: '48px 24px', color: C.t4, marginTop: 'auto' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        >
          <div>
            ...
            <div style={{ fontFamily: fs, fontSize: 13, lineHeight: 1.6 }}>
              Worker-Owned Home Care Cooperative, LLC
              <br />
              Boulder, CO · 2026
            </div>
          </div>
          <div style={{ fontFamily: fs, fontSize: 13, lineHeight: 1.6 }}>
            <strong>Blaine Warkentine, MD</strong>
            <br />
            <a href="mailto:blaine@co-op.care" style={{ color: C.t4, textDecoration: 'none' }}>
              blaine@co-op.care
            </a>{' '}
            · 484-684-5287
            <br />
            <br />
            <strong>Josh Emdur, DO</strong>
            <br />
            Medical Director · BCH Hospitalist
            <br />
            50-State Licensed
          </div>
        </div>
        ...
        >
          ...
          >
            Disclaimer: Age at Home Care Insurance is planned for 2028+ and is not a licensed
            insurance product today. The $100 founding family deposit is not an insurance premium.
            Class A license application pending. All services subject to availability and licensing.
          </div>
        </div>
      </div>
    </footer>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (
      ['website', 'product', 'enzyme', 'ubi', 'master', 'admin', 'dashboard', 'omaha'].includes(
        hash,
      )
    )
      setPage(hash);
    const handler = () => {
      ...
      if (
        ['website', 'product', 'enzyme', 'ubi', 'master', 'admin', 'dashboard', 'omaha'].includes(h)
      )
        setPage(h);
    };
