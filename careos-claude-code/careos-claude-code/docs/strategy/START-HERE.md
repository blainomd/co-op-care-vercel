...
**Updated:** March 10, 2026 — PostgreSQL replaces SurrealDB
...
As of March 10, we're using **PostgreSQL 16 + PostGIS** for the operational database. The SurrealDB schema in the codebase is retained for reference but is not the build target.
