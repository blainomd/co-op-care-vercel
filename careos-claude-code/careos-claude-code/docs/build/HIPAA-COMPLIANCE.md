...
| Encryption at rest | DONE | PostgreSQL encrypted storage, Redis ephemeral only (no PHI cached) |
...
- [ ] BAA (Business Associate Agreement) with PostgreSQL, Aidbox, Stripe, Twilio, SendGrid hosting providers
