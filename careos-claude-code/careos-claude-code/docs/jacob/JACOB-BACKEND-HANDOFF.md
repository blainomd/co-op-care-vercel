...
> **Database change (March 10):** All queries updated from SQL to PostgreSQL. Schema: `src/server/database/schema.sql`. Column names use snake_case per PostgreSQL convention. See `docs/JACOB-90-DAY-PLAN.md` for the full sprint plan.
